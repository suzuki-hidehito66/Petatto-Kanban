...
| 2.76.0 | 2026-08-15 | FR-014 / FR-028 実装。カレンダー当日・期限当日/超過をパレット化。4 テーマを暗色化 |
| 2.77.0 | 2026-08-15 | FR-028 仕様同期。パレット定義を `ui_theme_palettes.py` に分離 |
| 2.78.0 | 2026-08-15 | FR-025 / FR-028: 進捗バー塗りをテーマ連動（赤/黄/緑基調は維持） |
| 2.79.0 | 2026-08-15 | FR-025 実装。進捗塗りを `progress_fill.py` に分離 |

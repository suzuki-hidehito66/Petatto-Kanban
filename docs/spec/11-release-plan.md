...
| M2 | 拡張 | 表示モード（ウィンドウ・デスクトップ）、3 列カンバン、列間移動、複数ボード、ラベル、期限 | 計画 |
...
| 区分 | 内容 |
|------|------|
| 含む | FR-001〜005, FR-007, FR-010, FR-020, FR-021, FR-023, FR-024, NFR-001〜008, NFR-011 |
...
| カテゴリ | 完了 | 合計 |
|----------|------|------|
| FR (Must) | 2 verified + 8 implemented | 10 |

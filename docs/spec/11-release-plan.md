...
| 区分 | 内容 |
|------|------|
| 含む | FR-001〜005, FR-007, FR-010, FR-014, FR-020, FR-021, FR-023, FR-024, FR-025, FR-026, FR-027, FR-028, FR-029（Should）, FR-030（Should）, FR-031（Must・仕様のみ）, FR-032（Should・仕様のみ）, NFR-001〜008, NFR-011 |
...
| D-✓12 | エラー診断 | ローカル `logs/` 必須。GitHub Issue はオプトイン + ローカルトークン | 2026-08-14 | ADR-008 |

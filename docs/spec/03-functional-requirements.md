...
| [FR-018](#fr-018-ウィンドウモード) | ウィンドウモード | Must | verified | M1 |
| [FR-019](#fr-019-デスクトップモード) | デスクトップモード | Should | specified | M2 |
| [FR-020](#fr-020-オーバーレイモード) | オーバーレイモード | Should | specified | M2 |
| [FR-021](#fr-021-ディスプレイ指定) | ディスプレイ指定 | Should | specified | M2 |

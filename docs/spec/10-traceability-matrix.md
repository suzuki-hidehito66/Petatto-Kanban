...
| FR-030 | US-020 | AC-030-01〜05 | （予定）`system/hotkey.py`, `display/settings.py`, `display/settings_dialog_panels.py`, `display/settings_actions.py`, `app.py` | （予定）`test_hotkey.py`, `test_display_settings.py`, `test_settings_dialog.py`, `test_settings_actions.py` + 手動 | specified |
...
| UC-012 | FR-030, FR-003 | （予定）`system/hotkey.py`, `app.py` | （予定）`test_hotkey.py` + 手動 | specified |

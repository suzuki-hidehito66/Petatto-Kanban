...
| FR-030 | US-020 | AC-030-01〜05 | `system/hotkey.py`, `display/settings.py`, `display/settings_dialog_panels.py`, `display/settings_actions.py`, `app.py` | `test_hotkey.py`, `test_display_settings.py`, `test_settings_dialog.py`, `test_settings_actions.py` + 手動 | implemented |
...
| UC-006 | FR-005, FR-019, FR-020, FR-021, FR-022, FR-023, FR-024, FR-026, FR-027, FR-028, FR-029, FR-030 | `display/settings_dialog.py`, `settings_dialog_tabs.py`, `settings_dialog_labels.py`, `settings_dialog_panels.py`, `settings_actions.py`, `display/ui_scale.py`, `display/ui_font.py`, `display/ui_theme.py`, `system/auto_start.py`, `system/launch_command.py`, `system/hotkey.py`, `mode_labels.py`, `app.py` | `test_display_modes.py`, `test_settings_dialog.py`, `test_settings_actions.py`, `test_auto_start.py`, `test_launch_command.py`, `test_hotkey.py`, `test_ui_scale.py`, `test_ui_font.py`, `test_ui_theme.py` + 手動 | implemented |
| UC-012 | FR-030, FR-003 | `system/hotkey.py`, `app.py` | `test_hotkey.py` + 手動 | implemented |

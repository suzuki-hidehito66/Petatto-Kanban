...
| FR-031 | US-021 | AC-031-01, AC-031-02, AC-031-03 | `system/error_log.py`, `app.py`, `system/hotkey_pump.py` | `test_error_log.py` + 手動 | implemented |
| FR-032 | — | — | なし | — | cancelled |
...
| DC-004 | FR-031 | `system/error_log.py` | `test_error_log.py` | implemented |

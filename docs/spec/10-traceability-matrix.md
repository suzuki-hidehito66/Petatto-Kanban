...
| FR-025 | US-014 | AC-025-01, AC-025-02, AC-025-03, AC-025-04 | `app.py`, `progress.py`, `progress_fill.py` | `test_progress.py`, `test_ui_theme.py`, `test_board_roundtrip_dict_with_progress` | implemented |
...
| FR-028 | US-018 | AC-028-01, AC-028-02, AC-028-03, AC-028-04, AC-025-04 | `display/ui_theme.py`, `display/ui_theme_palettes.py`, `display/ui_theme_labels.py`, `settings.py`, `app.py`, `display/ui_chrome.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py`, `progress_fill.py` | `test_ui_theme.py`, `test_progress.py`, `test_settings_dialog.py`, `test_display_settings.py`, `test_settings_actions.py` + 手動 | implemented |
...
| UC-011 | FR-028 | `display/ui_theme.py`, `display/ui_theme_palettes.py`, `display/ui_theme_labels.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py`, `progress_fill.py`, `display/ui_chrome.py`, `app.py` | `test_ui_theme.py`, `test_progress.py` + 手動 | implemented |
...
| UC-008 | FR-014, FR-028 | `app.py`, `due_date.py`, `due_date_calendar.py`, `due_date_picker.py`, `card_ui.py`, `display/ui_theme.py`, `display/ui_theme_palettes.py` | `test_due_date.py`, `test_ui_theme.py` + 手動 | implemented |

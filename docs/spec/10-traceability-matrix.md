...
| FR-014 | US-015 | AC-014-01, AC-014-02, AC-014-03, AC-014-04, AC-014-05, AC-014-06 | `app.py`, `due_date.py`, `due_date_calendar.py`, `due_date_picker.py`, `card_ui.py`, `display/ui_theme.py` | `test_due_date.py`, `test_ui_theme.py`, `test_board_roundtrip_dict_with_due_date` | specified |
...
| FR-028 | US-018 | AC-028-01, AC-028-02, AC-028-03, AC-028-04 | `display/ui_theme.py`, `display/ui_theme_labels.py`, `settings.py`, `app.py`, `display/ui_chrome.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py` | `test_ui_theme.py`, `test_settings_dialog.py`, `test_display_settings.py`, `test_settings_actions.py` + 手動 | specified |
...
| FR-031 | US-021 | AC-031-01, AC-031-02, AC-031-03 | `system/error_log.py`, `system/error_log_paths.py`, `system/error_log_redact.py`, `app.py`, `system/hotkey_pump.py` | `test_error_log.py` + 手動 | implemented |
| FR-032 | — | — | なし | — | cancelled |
...
| DC-004 | FR-031 | `system/error_log.py`, `system/error_log_paths.py`, `system/error_log_redact.py` | `test_error_log.py` | implemented |
...
| UC-011 | FR-028 | `display/ui_theme.py`, `display/ui_theme_labels.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py`, `display/ui_chrome.py`, `app.py` | `test_ui_theme.py` + 手動 | specified |
...
| UC-008 | FR-014, FR-028 | `app.py`, `due_date.py`, `due_date_calendar.py`, `due_date_picker.py`, `card_ui.py`, `display/ui_theme.py` | `test_due_date.py`, `test_ui_theme.py` + 手動 | specified |
...
| 条件 | 状態 |
|------|------|
| Must の FR が `implemented` 以上 | ⚠️ FR-014 / FR-028 は配色契約更新のため `specified`（実装待ち） |
...
- [ ] FR-014 / FR-028 配色契約（カレンダー当日・期限当日/超過のテーマ連動、forest/ocean/sunset/midnight の暗い背景）を実装 → `implemented` へ更新

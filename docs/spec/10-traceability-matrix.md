...
| FR-028 | US-018 | AC-028-01, AC-028-02, AC-028-03, AC-028-04 | `display/ui_theme.py`, `display/ui_theme_palettes.py`, `display/ui_theme_labels.py`, `settings.py`, `app.py`, `display/ui_chrome.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py` | `test_ui_theme.py`, `test_settings_dialog.py`, `test_display_settings.py`, `test_settings_actions.py` + 手動 | implemented |
...
| UC-011 | FR-028 | `display/ui_theme.py`, `display/ui_theme_palettes.py`, `display/ui_theme_labels.py`, `card_renderer.py`, `menu_panel.py`, `due_date_picker.py`, `display/ui_chrome.py`, `app.py` | `test_ui_theme.py` + 手動 | implemented |

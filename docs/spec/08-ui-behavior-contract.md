...
| 関連 AC | AC-001-01, AC-019-01, AC-019-02, AC-019-03, AC-019-04, AC-020-01, AC-020-02 |
...
- **他アプリアクティブ時**は `DesktopBoardController.lower_on_foreign_pointer_press()`（他ウィンドウ上のマウス**押下**および**ドラッグ**）および `lower_on_foreign_app_active()`（前面ウィンドウ変更）で本体を即時背面へ（DM-DESKTOP-03）。離しを待たない
...
| 2.13.0 | 2026-08-14 | UC-002: 他ウィンドウクリックの背面復帰を押下時点に変更（DM-DESKTOP-03） |
| 2.13.1 | 2026-08-14 | UC-002: 他アプリ判定を `foreign_app` / `mouse_buttons` / `win32_user32` に分割 |
| 2.13.2 | 2026-08-14 | UC-002: 他ウィンドウのドラッグ中も即時背面復帰（DM-DESKTOP-03） |

"""10 種カラーテーマのパレット定義（FR-028 / UC-011）。"""

from __future__ import annotations

from petatto_kanban.display.ui_theme import UiTheme, UiThemePalette
...
_LIGHT_PROGRESS_FILL_LOW = "#dc3c3c"
_LIGHT_PROGRESS_FILL_MID = "#f0c828"
_LIGHT_PROGRESS_FILL_HIGH = "#3cb450"
_DARK_PROGRESS_FILL_LOW = "#c45c5c"
_DARK_PROGRESS_FILL_MID = "#c9a63a"
_DARK_PROGRESS_FILL_HIGH = "#4aa862"


PALETTES: dict[UiTheme, UiThemePalette] = {
    UiTheme.DEFAULT: UiThemePalette(
        ...
        progress_fill_low=_LIGHT_PROGRESS_FILL_LOW,
        progress_fill_mid=_LIGHT_PROGRESS_FILL_MID,
        progress_fill_high=_LIGHT_PROGRESS_FILL_HIGH,
    ...
    UiTheme.DARK: UiThemePalette(
        ...
        progress_fill_low=_DARK_PROGRESS_FILL_LOW,
        progress_fill_mid=_DARK_PROGRESS_FILL_MID,
        progress_fill_high=_DARK_PROGRESS_FILL_HIGH,
